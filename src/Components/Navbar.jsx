    ...
    return (
        <div className='w-screen h-[80px] z-10 bg-yellow-600 fixed drop-shadow-lg'>
            ...
            <ul className={!navig ? 'hidden' : 'md:hidden absolut bg-zinc-200 2-full px-8'}>
              ...
              <li className='border-b-2 border-zinc-300 w-full hover:bg-slate-300 cursor-pointer hover:text-yellow-600'><Link onClick={handleClick} to="about" smooth={true} offset={-200} duration={500}>About</Link></li>
